...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For i = 0 To 30 Step 1
            Chart1.Series("Humidade       ").Points.AddY(0)
            If Chart1.Series(0).Points.Count = ChartLimit Then
                Chart1.Series(0).Points.RemoveAt(0)
            End If

            Chart2.Series("Temperatura").Points.AddY(0)
    ...
    Private Sub ComboBoxPort_ParentChanged(sender As Object, e As EventArgs) Handles ComboBoxPort.ParentChanged
        PanelConnection.Focus()
    End Sub
        ...
        Try
            ...
            If TB.Lines.Count > 0 Then
                ...
                If vpb_sy < 0 Then
                    vpb_sy = 0
                End If
                PictureBoxPBTemp.Height = PictureBoxPBTemp.Height * vpb_sy / 120
                vpb_ly = (PictureBoxPBTemp.Height - vpb_sy) + PictureBoxPBTemp.Location.Y
                ...
                Chart1.Series("Humidade       ").Points.AddY(HumResult)
                If Chart1.Series(0).Points.Count = ChartLimit Then
                    Chart1.Series(0).Points.RemoveAt(0)
                End If
    ...
    Private Sub LinkLabelUtehStr_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabelUtehStr.LinkClicked
        Process.Start("https://www.youtube.com/channel/UCk8rZ8lhAH4H-75tQ7Ljc1A")
    End Sub
